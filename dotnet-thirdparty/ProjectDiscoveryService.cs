...
namespace DotNetOutdated.Services
{
    internal class ProjectDiscoveryService : IProjectDiscoveryService
    {
        ...
        public string DiscoverProject(string path)
        {
            ...
            // If a directory was passed in, search for a .csproj or .fsproj file
            if (fileAttributes.HasFlag(FileAttributes.Directory))
            {
                // Try and find individual projects
                ...
                // At this point the path contains no projects, so throw an exception
            ...
            // If a .csproj or .fsproj file was passed, just return that
